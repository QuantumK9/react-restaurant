  ...
  return (
    <div>
      ...
      <Segment basic style={{ fontFamily: 'Glook', color: '#FFF979' }}>
        <Container>
          <h1 class="one column stackable ui grid centered" style={{ fontFamily: 'Corinthia' }}><b><u>Nonna</u></b></h1>
          <h2 class="one column stackable ui grid centered" style={{ fontFamily: 'Corinthia' }}>Mediterranean Bistro</h2>
          <br /><br />
          <Container>
            <h3 class="one column stackable ui grid centered"> Welcome to Nonnas Bistro -  your one-stop-shop for all things delicious and Mediterranean! Our family-owned and operated takeaway serves up mouthwatering dishes that are sure to satisfy your cravings</h3>
            <br /><br />
          ...
          <div class="one column stackable ui grid">
            <div class="row">
              <div>
                <div class="six wide computer column centered" style={{ display: 'flex', justifyContent: 'center' }}>
                  <a style={{ position: 'relative', zIndex: '1' }} href='#'><button class="ui yellow  basic button">Explore More</button></a>
          ...
          <div class="one column stackable ui grid centered">
            ...
            <h3> Nonna's Mediterranean Bistro - we are a family-run business that prides itself on delivering authentic Mediterranean cuisine using fresh and high-quality ingredients. Our recipes have been   passed down from generations and are rooted in the traditions of the Mediterranean.</h3>
            <idv></idv>
          </div>
        </Container>
      </Segment>
      ...
      <div class="ui one column stackable ui grid centered" style={{marginTop:'100'}}>
