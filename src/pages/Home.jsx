    ...
    <div>
      <Segment basic style={{ fontFamily: 'Glook', color: '#FFF979' }}>
        <Container>
          ...
          <br /><br />
          <Container>
            <h3 className="one column stackable ui grid centered"> Welcome to Nonna's Bistro -  your one-stop-shop for all things delicious and Mediterranean! Our family-owned and operated takeaway serves up mouthwatering dishes that are sure to satisfy your cravings</h3>
            <br /><br />
          </Container>
            ...
            <div className="row">
              <div>
                <div className="six wide computer column centered" style={{ display: 'flex', justifyContent: 'center' }}>
                  <a style={{ position: 'relative', zIndex: '1' }} href='#'><button class="ui inverted yellow button">Explore More</button></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="ui grid" style={{ color: 'white', backgroundColor: '#94252e' }}>
          <div className="one column stackable ui grid centered">
            ...
            <div className="sixteen wide column">
              <Container>
                <h1 className="one column stackable ui grid centered" style={{ fontFamily: 'Corinthia' }}> About</h1>
                <h3 className="one column stackable ui grid centered"> Nonna's Mediterranean Bistro - we are a family-run business that prides itself on delivering authentic Mediterranean cuisine using fresh and high-quality ingredients. Our recipes have been   passed down from generations and are rooted in the traditions of the Mediterranean.</h3>
              </Container>
              <br />
            </div>
            <div className="ui divider"></div>
